function [G,P, D, short_term_memory, long_term_memory, optimal_traj, best_actions] = tree_search_frwd_UCB(long_term_memory, short_term_memory, O, P, a, A,y, D, B,b, t, T, N, t_food,t_water,t_sleep,f,w,s, resource_locations, current_state, true_t, chosen_action, novelty, surety, simulated_time, true_t_food, true_t_water, true_t_sleep, hill_visited, optimal_traj, best_actions, Nt)
            ...
            if short_term_memory(t_food,t_water,t_sleep,cur_state, action) ~= 0 
                ...
                for state = likely_states(:)'
                    ...
                    % this state
                        ...
                        % the tree
                        [expected_free_energy, d, D, short_term_memory, long_term_memory, optimal_traj, best_actions] = tree_search_frwd_UCB(long_term_memory, short_term_memory, O, P, a, A,y, D, B,b, t+1, T, N, t_food_approx,t_water_approx,t_sleep_approx,t_food_approx,t_water_approx,t_sleep_approx, resource_locations, state, true_t, chosen_action, novelty, surety, 0, true_t_food, true_t_water, true_t_sleep, hill_visited, optimal_traj, best_actions, Nt);
